 ...
 * @since 2.8.0
 */
class Core2_Widget_Pages extends WP_Widget {
 ...
 * @since 2.8.0
 */
class Core2_Widget_Archives extends WP_Widget {
 ...
 * @since 2.8.0
 */
class Core2_Widget_Recent_Posts extends WP_Widget {
				...
				<div class="row no-gutters">
					<?php if ( $show_date ) : ?>
						...
						<div class="latest_news_content">
							<a href="<?php the_permalink(); ?>" class="latest_news_title h3"><?php get_the_title() ? the_title() : the_ID(); ?></a>
							<div class="latest_news_excerpt"><?php get_the_excerpt() ? the_excerpt() : ''; ?></div>
							<a href="<?php the_permalink(); ?>" class="latest_news_link">View Post</a>
						</div>
					</div>
				</div>
			</div>
