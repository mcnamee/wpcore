...
function wpcore_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'color_scheme', array(
		'default'           => 'default',
		'sanitize_callback' => 'wpcore_sanitize_color_scheme',
...
/**
 * Register color schemes for WPCore.
 *
 * Can be filtered with {@see 'wpcore_color_schemes'}.
 *
...
if ( ! function_exists( 'wpcore_get_color_scheme' ) ) :
/**
 ...
 */
function wpcore_get_color_scheme() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	$color_schemes       = wpcore_get_color_schemes();
...
endif; // wpcore_get_color_scheme

if ( ! function_exists( 'wpcore_get_color_scheme_choices' ) ) :
/**
 ...
 */
function wpcore_get_color_scheme_choices() {
	$color_schemes                = wpcore_get_color_schemes();
...
endif; // wpcore_get_color_scheme_choices

if ( ! function_exists( 'wpcore_sanitize_color_scheme' ) ) :
/**
 ...
 */
function wpcore_sanitize_color_scheme( $value ) {
	$color_schemes = wpcore_get_color_scheme_choices();
...
endif; // wpcore_sanitize_color_scheme
 ...
 */
function wpcore_color_scheme_css() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	...
	$color_textcolor_rgb         = wpcore_hex2rgb( $color_scheme[3] );
	$color_sidebar_textcolor_rgb = wpcore_hex2rgb( $color_scheme[4] );
	$colors = array(
	...
	$color_scheme_css = wpcore_get_color_scheme_css( $colors );

	wp_add_inline_style( 'wpcore-style', $color_scheme_css );
}
add_action( 'wp_enqueue_scripts', 'wpcore_color_scheme_css' );
...
function wpcore_customize_control_js() {
	...
	wp_localize_script( 'color-scheme-control', 'colorScheme', wpcore_get_color_schemes() );
}
add_action( 'customize_controls_enqueue_scripts', 'wpcore_customize_control_js' );
 ...
 */
function wpcore_get_color_scheme_css( $colors ) {
...
function wpcore_color_scheme_css_template() {
	...
	?>
	<script type="text/html" id="tmpl-wpcore-color-scheme">
		<?php echo wpcore_get_color_scheme_css( $colors ); ?>
	</script>
	<?php
}
add_action( 'customize_controls_print_footer_scripts', 'wpcore_color_scheme_css_template' );
